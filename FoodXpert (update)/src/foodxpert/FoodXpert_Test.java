...
public class FoodXpert_Test {   
    public static void main(String[] args) {
        ...
        int fx, phn, pin, fi, dash, pcode, pay;       // © 2020-2021, FoodXpert.                               
        Scanner inp = new Scanner(System.in);        //  All Rights Reserved                                                
        fx = inp.nextInt();                         //  @author: Shohanur Rahman 
        switch (fx) {                              //  GitHub:https://github.com/shohan3401/FoodXpert                         
            case 1:                               
                ...
                switch (dash) {
                    case 1:
                        ...
                        switch (fi) {
                            ...
                            case 2:
                                System.out.println("\n*SNACK: ");
                                FoodXpert_Inhe jav = new FoodXpert_Inhe();
                                jav.sn3 = "Pastries";
                                jav.sn4 = "Bread/Sandwiches";
                                jav.sn5 = "Cheese";
                                jav.fx_show();
                                FoodXpert_Inhe_p jav1 = new FoodXpert_Inhe_p();
                                jav1.sn1 = "Cookies";
                                jav1.sn2 = "Cakes";
                                jav1.fx1_show();
                                break;
                            case 3:
                                System.out.println("\n*COFFEE: ");               //dmor
                                FoodXpert_Inhe_p cav = new FoodXpert_Inhe_p();
                                cav.poly_show();
                                cav = new FoodXpert_Inhe();
                                cav.poly_show();
                                break;
                            case 4:
                                System.out.println("\n*RICH FOOD: ");
